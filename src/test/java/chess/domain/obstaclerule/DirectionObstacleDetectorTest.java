...
//
//class DirectionObstacleDetectorTest {
//
//    /*
//     * ........
//     * ........
...
//        DirectionObstacleDetector directionAttacker = new DirectionObstacleDetector();
//
//        Position sourcePosition = Position.of(3, 2);
//        Position targetPosition = Position.of(3, 4);
//        Position obstaclePosition = Position.of(3, 3);
//
//        List<Position> obstacle = directionAttacker.findObstacle(sourcePosition, targetPosition,
//                Map.of(sourcePosition, new Pawn(Color.BLACK),
...
//        List<Position> obstacle = directionAttacker.findObstacle(sourcePosition, targetPosition,
//                Map.of(sourcePosition, new Pawn(Color.BLACK),
//                        targetPosition, new Pawn(Color.WHITE)));
//
...
//        List<Position> obstacle = directionAttacker.findObstacle(sourcePosition, targetPosition,
//                Map.of(sourcePosition, new Pawn(Color.BLACK),
//                        targetPosition, new Pawn(Color.BLACK)));
//
